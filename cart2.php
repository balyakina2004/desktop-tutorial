...
<!--общий контейнер-->
    ...
    <input type='text' name='orderid' placeholder='введите номер телефона'/> <br />
				...
				<form action="asset/controllers/checkout.php"  method="POST" class="cart2f">
					<input type="password" placeholder="Ваш пароль" name="password" required>
					<button style="margin-bottom:5px">Сформировать заказ</button>
				</form>
